 ...
 * 
 * import com.mpsedc.configuration.JwtUtil; import
 ...
 * 
 * @Autowired private JwtUtil jwtUtil; LoginServiceImpl loginServiceImpl =new
 * LoginServiceImpl();
 * 
 ...
 * jwtUtil.extractUsername(jwt); } catch (ExpiredJwtException e) { // Handle
 * expired token } }
 * 
 * if (username != null &&
